...
const routes: Routes = [
    {
        ...
        children: [
            ...
            // { path: 'volunteers/edit', loadChildren: './edit-volunteer/edit-volunteer.module#EditVolunteerModule' },
            // { path: 'events/edit', loadChildren: './edit-event/edit-event.module#EditEventModule' },
