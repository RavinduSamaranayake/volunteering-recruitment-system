...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'notify-going/:id', loadChildren: './view-organization/view-organization.module#ViewOrganizationModule' },
            { path: 'notify-delete/:id', loadChildren: './view-event/view-event.module#ViewEventModule' },
        ]
    }
];
